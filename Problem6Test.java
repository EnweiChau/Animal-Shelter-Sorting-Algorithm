...
public class Problem6Test {
    ...
    BEFORE: 107 milliseconds
    AFTER: 16 ms
    Improvement: 91 ms
    I improved my code by shortening the process on the right side/the larger number side.
    I did this by adding node.val.getAge() <= ageEnd.
    This line of code checks to see if the node's age is less than or equal to the ageEnd.
    If not, then it would break out of while loop.
     */
    @Test
